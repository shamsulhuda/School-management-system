                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            @if (Auth::check())
                            <li><i class="fa fa-user mr-2"> </i></li>
                            <li>
                                <label><strong>{{Auth::user()->name}}</strong><span class="fa fa-angle-down" aria-hidden="true"></span></label>
                                <ul>
                                    <li><a href="{{route('home')}}" class="drop-text">Dashboard</a></li>
